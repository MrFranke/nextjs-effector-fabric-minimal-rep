...
import { EffectorReact, EffectorReactImports, setEffectorReact } from './effector-react'
import { env } from './env'
...
export function withEffector(App: NextComponentType<AppContext, any, any>, { effectorReact }: Options) {
